...
```
**[38. Meeting Rooms](https://leetcode.com/problems/meeting-rooms/description/)**

This is one of the **most important interval problems** in interviews.

Given meetings:
```txt
[start, end]
```
Determine: Can one person attend all meetings?
